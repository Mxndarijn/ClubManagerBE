...
@Component
public class AssociationContactEmailDataFetcher implements DataFetcher<String> {
    private final UserAssociationRepository userAssociationRepository;

    public AssociationContactEmailDataFetcher(UserAssociationRepository userAssociationRepository) {
    ...
    public String get(DataFetchingEnvironment environment) throws Exception {
        ...
        if(SecurityContextHolder.getContext().getAuthentication().getPrincipal() instanceof User contextUser) {
            ...
            if(hasAssociation)
                return association.getContactEmail();
        }
